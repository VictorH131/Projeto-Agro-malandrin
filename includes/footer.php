    ...
    <div id="footer"> <!-- footer das paginas -->
        ...
        <div id="logo"><!-- a logo que fica no footer -->
            <a href="#header">
            <img src="multimidia/Logo_Home.png" alt="logo da agro malandrin">
            </a>
        </div>
        ...
        <div id="linksfora">  <!-- os links de fora (para outros sites) --> 
            <h1 id="titulo">Contate-nos</h1>
                ...
                <div id="cont">
                     <a href="https://www.facebook.com/agromalandrin/" target="_blank" id="linkfoo"> <li id="facefoo"> FaceBook </li> </a> 

                     <a href="https://www.instagram.com/agromalandrin/" target="_blank" id="linkfoo"> <li id="instfoo"> Instagram </li> </a>                   
                </div>
                
                <div id="cont">
                    <a href="https://wa.me/551938431393"  target="_blank" id="linkfoo"> <li id="whatfoo"> Whatsapp </li> </a> 
